...
try:
    ...
    logger.error("请确保 gcode_sender_fixed.py 在同一目录")
    sys.exit(1)
...
if ROS_AVAILABLE:
    try:
        ...
        logger.error("请确保 robot_speed_controller_fixed.py 在同一目录")
        sys.exit(1)
...
def main():
    ...
    parser.add_argument('--speed-source', default='/kmriiwa/base/state/odom', choices=['odom', 'cmd_vel'],
